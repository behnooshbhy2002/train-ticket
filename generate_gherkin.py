...
user_stories = [
    ...
    # "As a user, I want to log in to my account so that I can access my profile and booking history.", done
    ...
    # "As a user, I want to verify my ticket after I have obtained it, so that I can confirm its validity and ensure it is ready for use."done
...
# فراخوانی تابع برای تبدیل یوزر استوری به Gherkin
